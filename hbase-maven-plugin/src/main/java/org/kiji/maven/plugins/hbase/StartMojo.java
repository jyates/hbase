...
public class StartMojo extends BaseClusterMojo {
   ...
   *
   * @parameter property="hbase.site.file" default-value="${project.build.testOutputDirectory}/hbase-site.xml"
   * @required
   */
   ...
   *
   * @parameter property="separate.configuration.files" default-value="true"
   */
   ...
   *
   * @parameter property="core.site.file" default-value="${project.build.testOutputDirectory}/core-site.xml"
   * @required
   */
   ...
   *
   * @parameter property="hbase.conf.index.write" default-value="false"
   */
   ...
   *
   * @parameter property="hbase.conf.index.file" default-value="${project.build.testOutputDirectory}/conf-index.conf"
   */
   ...
   *
   * @parameter property="mapreduce.enabled" default-value="false"
   */
