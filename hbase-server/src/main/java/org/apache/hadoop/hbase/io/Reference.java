...
public class Reference implements Writable {
   ...
   */
  public static final Pattern REF_OR_HFILE_NAME_PARSER = Pattern.compile("^([0-9a-f]+)(?:\\.(.+))?$");
  ...
  /**
   * @param m Matcher constructed around a file name (should be based on {@link #REF_OR_HFILE_NAME_PARSER}).
