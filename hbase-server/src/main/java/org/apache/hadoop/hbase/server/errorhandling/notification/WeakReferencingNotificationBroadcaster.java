 ...
 */
public class WeakReferencingNotificationBroadcaster extends NotificationBroadcasterSupport {

  static final Log LOG = LogFactory.getLog(WeakReferencingNotificationBroadcaster.class);
