...
/**
 * An {@link ErrorSnare} that throws a specific checked exception, rather than a general
 * {@link Exception} when checking {@link #failOnException()}.
 * @param <E> type of {@link Exception} to throw
 */
public abstract class CheckedErrorSnare<E extends Exception> extends ErrorSnare {
