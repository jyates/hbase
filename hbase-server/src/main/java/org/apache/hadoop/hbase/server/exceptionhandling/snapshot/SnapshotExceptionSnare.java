...
import org.apache.hadoop.hbase.server.errorhandling.CheckedErrorSnare;
import org.apache.hadoop.hbase.server.errorhandling.ExceptionSnare;
import org.apache.hadoop.hbase.snapshot.exception.HBaseSnapshotException;
import org.apache.hadoop.hbase.snapshot.exception.UnexpectedSnapshotFailureException;

/**
 * An {@link ExceptionSnare} that only returns {@link HBaseSnapshotException} on calls to
...
public class SnapshotExceptionSnare extends CheckedErrorSnare<HBaseSnapshotException> {
  ...
  protected HBaseSnapshotException map(Exception e) {
    ...
    return new UnexpectedSnapshotFailureException("Snapshot failed due to outside influence.", e,
        snapshot);
  }
