 ...
 * <p>
 * You can think of it like a 'one-time-use' {@link ExceptionCheckable} - once it receives an error will
 * not listen to any new error updates.
 * <p>
 * Thread-safe.
 */
public class ExceptionSnare implements NotificationListener, ExceptionCheckable {
  ...
  @Override
  public synchronized boolean checkForException() {
    return this.found;
  }

  @Override
  public synchronized void failOnException() throws Exception {
