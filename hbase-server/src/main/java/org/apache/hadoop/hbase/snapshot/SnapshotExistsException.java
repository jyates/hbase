...
public class SnapshotExistsException extends HBaseSnapshotException {
  ...
  public SnapshotExistsException(String msg, SnapshotDescriptor desc) {
    super(msg, desc);
  }

  public SnapshotExistsException(String msg, Throwable cause, SnapshotDescriptor desc) {
  ...
  public SnapshotExistsException(Throwable cause, SnapshotDescriptor desc) {
    super(cause, desc);
  }
