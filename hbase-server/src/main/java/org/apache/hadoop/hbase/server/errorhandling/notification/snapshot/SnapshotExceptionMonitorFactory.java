...
public class SnapshotExceptionMonitorFactory {
  ...
  private WeakReferencingNotificationBroadcaster broadcaster = new WeakReferencingNotificationBroadcaster();
  ...
  public WeakReferencingNotificationBroadcaster getBroadcaster() {
