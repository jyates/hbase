...
public interface MasterSnapshotStatusListener {
  ...
  /**
   * Idempotent operation to indicate that a rs aborted a snapshot
   */
  public void rsAbortedSnapshot(String rsID);

  /**
   * Idempotent operation to indicate that a rs is prepared to take a snapshot
   */
  public void rsJoinedSnapshot(String rsID);

  /**
   * Idempotent operation to indicate that a rs has successfully completed a
   * snapshot
   */
