 ...
 * <p>
 * {@link HFileArchiveTracker#start()} needs to be called to start monitoring
...
public class HFileArchiveTracker extends ZooKeeperListener implements HFileArchiveMonitor {
  ...
  private volatile HFileArchiveTableMonitor tracker;

  private HFileArchiveTracker(ZooKeeperWatcher watcher, HFileArchiveTableMonitor tracker) {
    super(watcher);
   ...
   */
  public final HFileArchiveTableMonitor getTracker() {
    return this.tracker;
  }
   ...
   */
  public static HFileArchiveTracker create(ZooKeeperWatcher zkw, Server parent) {
   ...
   *         archive hfiles for a given table
   */
  public static HFileArchiveTracker create(ZooKeeperWatcher zkw, HFileArchiveTableMonitor monitor) {
    return new HFileArchiveTracker(zkw, monitor);
  }
}
